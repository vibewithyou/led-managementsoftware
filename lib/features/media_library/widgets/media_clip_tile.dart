...
class MediaClipTile extends StatefulWidget {
  const MediaClipTile({required this.asset, required this.isSelected, required this.onTap, super.key});
...
class _MediaClipTileState extends State<MediaClipTile> {
  bool _hovered = false;
                  ...
                  child: Container(
                    ...
                    child: widget.asset.thumbnailPath.isEmpty
                        ...
                        : Image.network(
                            ...
                            fit: BoxFit.cover,
                            width: double.infinity,
                            errorBuilder: (_, __, ___) => const Icon(Icons.video_file_rounded, color: AppColors.textMuted, size: 30),
                          ),
                  ),
                ),
